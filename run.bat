echo off
set Keyword_Finder=.\keyword_finder.jar
set PORT="5566"
if exist "%Keyword_Finder%" goto Keyword_Finder
echo Could not locate the Keyword Finder JAR FILE. MAKE SURE YOU EXECUTE THIS SCRIPT FROM THE DIRECTORY OF THE JAR FILE
GOTO END
...
if not "%JAVAC_JAR%" == "" set IMSASJAR=%JAVAC_JAR%;%Keyword_Finder%
set RUN_CLASSPATH=%Keyword_Finder%
if "%RUN_CLASSPATH%" == "" set RUN_CLASSPATH=%Keyword_Finder%
